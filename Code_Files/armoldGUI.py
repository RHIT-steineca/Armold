...
class ArmoldGUI():
    ...
    def fillWindow(self):
        ...
        recordButtonFrame = tk.Frame(self.controlsframe, width=self.controlsFrameWidth)
        ...
        self.recordButton = tk.Button(self.recordButtonMargin, text="New Recording", command=lambda : self.closeWindow())
        self.recordButton.pack(side="left", expand=True, fill="both")
        self.recordButtonCanvas = tk.Canvas(recordButtonFrame, width=4+3*self.borderPadding, height=4+3*self.borderPadding)
