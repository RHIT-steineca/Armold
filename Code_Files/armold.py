...
class TestEnvironment:
    ...
    def setupWindow(testenv):
        ...
        testenv.buttonFrame.pack(side="top", expand=True, fill="both")
        rebootButton = tk.Button(testenv.buttonFrame, text="Reboot Armold\n(Restart Pi)", padx=30, pady=30, command=lambda : os.system("sudo reboot")).pack(side="left")
        closeButton = tk.Button(testenv.buttonFrame, text="Close Testing Window", padx=30, pady=30, command=lambda : testenv.closeWindow()).pack(side="right")
