...
limitedMaxDegs = {"shoulderCB":270,"shoulderR":1333,"shoulderLR":270,"elbow":235,"wrist":230,"fingerPTR":180,"fingerMDL":180,"fingerRNG":160,"fingerPKY":180,"fingerTHM":120}
...
class ArmoldBrain:
    ...
    def convertToActuatorVals(brain, sensorVals):
        ...
        for name, val in sensorVals.items():
            ...
            # reverse directions
            if ("fingerTHM" in name or "elbow" in name):
