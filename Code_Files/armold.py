    ...
    def updateWindow(testenv):
        for actuatorName, actuatorVal in testenv.valpairs.items():
            if actuatorName in testenv.labelpairs.keys():
                ...
                label.config(text=f"{actuatorName}: {round(testenv.convertAngleToVal(actuatorName, actuatorVal), 1)} Steps, {round(actuatorVal, 1)} Degrees", font=("Courier Prime Regular", 14))
                label.pack()
        testenv.frame.pack()
...
class ArmoldGUI():
    ...
    def fillWindow(self):
        ...
        debugButton = ctk.CTkButton(tekButtonMargin, height=5*self.borderPadding, image=debugButtonImage, text="Open Debug Window", font=("Courier Prime Regular", 18), text_color="#000000", fg_color="#FFFFFF", bg_color="transparent", hover_color="#EAF1FF", corner_radius=15, command=lambda : self.showDebugWindow())
        ...
        closeButton = ctk.CTkButton(tekButtonMargin, height=5*self.borderPadding, image=powerButtonImage, text="Shut Down", font=("Courier Prime Regular", 18), text_color="#000000", fg_color="#FFFFFF", bg_color="transparent", hover_color="#EAF1FF", corner_radius=15, command=lambda : self.closeWindow())
    ...
    def updateGraphics(self):
        ...
        # set status message
        self.statusMessage = tk.Label(self.statusAreaFrame, text=self.stateText, font=("Courier Prime Regular", 32), background="#EAF1FF", justify="left")
        ...
        if(self.state == "idle"):
            ...
            for rn, rec in brain.recordedMovements.items():
                ...
                nameLabel = ctk.CTkLabel(playbackFrame, text=name, font=("Courier Prime Regular", 32), text_color="#000000", justify="left")
                ...
                durationLabel = ctk.CTkLabel(playbackFrame, text=duration, font=("Courier Prime Regular", 32), text_color="#000000")
            ...
            self.recordButton = ctk.CTkButton(self.recordButtonMargin, image=recordButtonImage, text="New Recording", font=("Courier Prime Regular", 32), text_color="#000000", fg_color="#FFFFFF", bg_color="#FFFFFF", hover_color="#EAF1FF", border_color="#DDDDDD", border_width=self.borderPadding, corner_radius=15, command=lambda : self.startRecording())
            ...
            self.mirrorButton = ctk.CTkButton(self.mirrorButtonMargin, image=mirrorButtonImage, text="Live Control", font=("Courier Prime Regular", 32), text_color="#000000", fg_color="#FFFFFF", bg_color="#FFFFFF", hover_color="#EAF1FF", border_color="#DDDDDD", border_width=self.borderPadding, corner_radius=15, command=lambda : self.startMirror())
            ...
            # mirror button
            mirrorButtonImage = ctk.CTkImage(Image.open("gui_icons/mirror.png"), size=(7*round(self.borderPadding),7*round(self.borderPadding)))
            self.mirrorButton = ctk.CTkButton(self.mirrorButtonMargin, image=mirrorButtonImage, text="Stop Control", font=("Courier Prime Regular", 32), text_color="#000000", fg_color="#EAF1FF", bg_color="#FFFFFF", hover_color="#EAF1FF", border_color="#DDDDDD", border_width=self.borderPadding, corner_radius=15, command=lambda : self.stopMirror())
            self.mirrorButton.pack(side="left", expand=True, fill="both")
            self.mirrorButtonCanvas = tk.Canvas(self.mirrorButtonMargin, width=3*self.borderPadding, height=3*self.borderPadding, bd=0, highlightthickness=0, background="#FFFFFF")
            self.mirrorButtonCanvas.pack(side="right", padx=(self.borderPadding, 2*self.borderPadding), expand=False, fill="none")
            ...
            self.playbackDuration = tk.Label(self.loopButtonMargin, text="0:00\n/0:00", font=("Courier Prime Regular", 20), background="#EAF1FF", bd=0, highlightthickness=0, justify="right")
            ...
            if(self.playbackLoop == True):
                self.loopButton = ctk.CTkButton(self.loopButtonMargin, image=loopButtonImage, text="Loop", font=("Courier Prime Regular", 32), text_color="#FFB800", fg_color="#FFD9A0", bg_color="#EAF1FF", hover_color="#FFD9A0", border_color="#FFB800", border_width=self.borderPadding, corner_radius=15, command=lambda : self.toggleLoop())
            else:
                self.loopButton = ctk.CTkButton(self.loopButtonMargin, image=loopButtonImage, text="Loop", font=("Courier Prime Regular", 32), text_color="#000000", fg_color="#FFFFFF", bg_color="#EAF1FF", hover_color="#FFD9A0", border_color="#DDDDDD", border_width=self.borderPadding, corner_radius=15, command=lambda : self.toggleLoop())
            ...
            for rn, rec in brain.recordedMovements.items():
                ...
                if(name == self.playing):
                    ...
                    playbackFrame.pack(side="top", expand=False, fill="x", padx=(0,self.borderPadding), pady=self.borderPadding)
                    nameLabel = ctk.CTkLabel(playbackFrame, text=name, font=("Courier Prime Regular", 32), text_color="#BDBDBD", justify="left")
                    nameLabel.pack(side="left", expand=False, fill="x", padx=self.borderPadding, pady=self.borderPadding)
                    ...
                    playbackButtonsFrame.pack(side="right", expand=False, fill="none", padx=self.borderPadding, pady=self.borderPadding)
                    durationLabel = ctk.CTkLabel(playbackFrame, text=duration, font=("Courier Prime Regular", 32), text_color="#BDBDBD")
                    durationLabel.pack(side="right")
            ...
            self.recordButton = ctk.CTkButton(self.recordButtonMargin, image=recordButtonImage, text="New Recording", font=("Courier Prime Regular", 32), text_color="#BDBDBD", fg_color="#DADADA", bg_color="#DADADA", hover_color="#DADADA", border_color="#BDBDBD", border_width=self.borderPadding, corner_radius=15)
            self.recordButton.pack(side="left", expand=True, fill="both")
            self.recordButtonCanvas = tk.Canvas(self.recordButtonMargin, width=3*self.borderPadding, height=3*self.borderPadding, bd=0, highlightthickness=0, background="#FFFFFF")
            self.recordButtonCanvas.pack(side="right", padx=(self.borderPadding, 2*self.borderPadding), expand=False, fill="none")
            self.recordButtonCanvas.create_oval(0,0,3*self.borderPadding,3*self.borderPadding, fill="#BABFC9", outline="#FFFFFF")
            ...
            self.mirrorButton = ctk.CTkButton(self.mirrorButtonMargin, image=mirrorButtonImage, text="Live Control", font=("Courier Prime Regular", 32), text_color="#BDBDBD", fg_color="#DADADA", bg_color="#DADADA", hover_color="#DADADA", border_color="#BDBDBD", border_width=self.borderPadding, corner_radius=15)
            self.mirrorButton.pack(side="left", expand=True, fill="both")
            self.mirrorButtonCanvas = tk.Canvas(self.mirrorButtonMargin, width=3*self.borderPadding, height=3*self.borderPadding, bd=0, highlightthickness=0, background="#FFFFFF")
            self.mirrorButtonCanvas.pack(side="right", padx=(self.borderPadding, 2*self.borderPadding), expand=False, fill="none")
            self.mirrorButtonCanvas.create_oval(0,0,3*self.borderPadding,3*self.borderPadding, fill="#BABFC9", outline="#FFFFFF")
            ...
            # record button
            recordButtonImage = ctk.CTkImage(Image.open("gui_icons/record.png"), size=(7*round(self.borderPadding),7*round(self.borderPadding)))
            self.recordButton = ctk.CTkButton(self.recordButtonMargin, image=recordButtonImage, text="End Recording", font=("Courier Prime Regular", 32), text_color="#000000", fg_color="#EAF1FF", bg_color="#FFFFFF", hover_color="#EAF1FF", border_color="#DDDDDD", border_width=self.borderPadding, corner_radius=15, command=lambda : self.stopRecording())
            self.recordButton.pack(side="left", expand=True, fill="both")
            self.recordButtonCanvas = tk.Canvas(self.recordButtonMargin, width=3*self.borderPadding, height=3*self.borderPadding, bd=0, highlightthickness=0, background="#FFFFFF")
            self.recordButtonCanvas.pack(side="right", padx=(self.borderPadding, 2*self.borderPadding), expand=False, fill="none")
    ...
    def stopRecording(self):
        ...
        infoLabel = ctk.CTkLabel(recordingInfoLabelBorder, text="Nice! Your recording is complete...\nWhat did you just teach Armold to do?", font=("Courier Prime Regular", 52), text_color="#000000")
        ...
        recordingNameEntry = ctk.CTkEntry(recordingEntriesBorder, textvariable=recordingName, placeholder_text="", font=("Courier Prime Regular", 32), text_color="#000000", fg_color="#EAF1FF", bg_color="#FFFFFF", border_color="#5D6D8B", border_width=self.borderPadding, corner_radius=15)
        ...
        cancelButton = ctk.CTkButton(recordingEntriesBorder, image=cancelImage, text="Cancel", font=("Courier Prime Regular", 32), text_color="#842C2C", fg_color="#F64242", bg_color="#FFFFFF", hover_color="#F64242", border_color="#842C2C", border_width=self.borderPadding, corner_radius=15, command=lambda : self.cancelRecording())
        ...
        acceptButton = ctk.CTkButton(recordingEntriesBorder, image=acceptImage, text="Accept", font=("Courier Prime Regular", 32), text_color="#34B801", fg_color="#42F65E", bg_color="#FFFFFF", hover_color="#42F65E", border_color="#34B801", border_width=self.borderPadding, corner_radius=15, command=lambda : self.acceptRecording(recordingName.get()))
    ...
    def deleteRecording(self, name):
        ...
        acceptImage = ctk.CTkImage(Image.open("gui_icons/accept.png"), size=(7*round(self.borderPadding),7*round(self.borderPadding)))
        acceptButton = ctk.CTkButton(recordingEntriesBorder, image=acceptImage, text="Accept", font=("Courier Prime Regular", 32), text_color="#34B801", fg_color="#42F65E", bg_color="#FFFFFF", hover_color="#42F65E", border_color="#34B801", border_width=self.borderPadding, corner_radius=15, command=lambda : self.acceptDelete(name))
        acceptButton.pack(side="left", expand=True, fill="both", padx=5*self.borderPadding)
        cancelImage = ctk.CTkImage(Image.open("gui_icons/cancel.png"), size=(7*round(self.borderPadding),7*round(self.borderPadding)))
        cancelButton = ctk.CTkButton(recordingEntriesBorder, image=cancelImage, text="Cancel", font=("Courier Prime Regular", 32), text_color="#842C2C", fg_color="#F64242", bg_color="#FFFFFF", hover_color="#F64242", border_color="#842C2C", border_width=self.borderPadding, corner_radius=15, command=lambda : self.cancelDelete())
